...
namespace MoodTube.Controllers
{
    ...
    */
        ...
        public async Task<IActionResult> Create([Bind("SongID,SongName,SingerID,MoodID")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("SongID,SongName,SingerID,MoodID")] Song song)
        {
            if (id != song.SongID)
            {
                return NotFound();
